...
/* MPI Function Calls */
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_close);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_set_size);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_iread_at);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_iread);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_iread_shared);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_iwrite_at);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_iwrite);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_iwrite_shared);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_open);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_read_all_begin);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_read_all);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_read_at_all);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_read_at_all_begin);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_read_at);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_read);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_read_ordered_begin);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_read_ordered);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_read_shared);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_set_view);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_sync);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_write_all_begin);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_write_all);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_write_at_all_begin);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_write_at_all);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_write_at);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_write);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_write_ordered_begin);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_write_ordered);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_write_shared);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Finalize);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Finalized);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Init);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Init_thread);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Wtime);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Comm_rank);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Comm_size);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Get_processor_name);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Comm_set_errhandler);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Barrier);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Bcast);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Gather);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Gatherv);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Scatter);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Scatterv);
//RECORDER_WRAPPEE_HANDLE_DEF(MPI_Allgather);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Allgatherv);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Alltoall);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Reduce);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Allreduce);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Reduce_scatter);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Scan);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Type_commit);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Type_contiguous);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Type_extent);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Type_free);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Type_hindexed);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Op_create);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Op_free);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Type_get_envelope);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Type_size);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Type_create_darray);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_get_size);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Cart_rank);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Cart_create);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Cart_get);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Cart_shift);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Wait);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Send);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Recv);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Sendrecv);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Isend);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Irecv);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Info_create);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Info_set);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Info_get);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Waitall);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Waitsome);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Waitany);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Ssend);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Comm_split);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Comm_dup);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Comm_create);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_seek);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_File_seek_shared);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Ibcast);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Test);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Testall);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Testsome);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Testany);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Ireduce);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Igather);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Iscatter);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Ialltoall);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Comm_free);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Cart_sub);
RECORDER_WRAPPEE_HANDLE_DEF(MPI_Comm_split_type);
...
struct gotcha_binding_t recorder_wrappers[] = {
    ...
    { "MPI_Wtime", RECORDER_MPI_DECL(MPI_Wtime), &RECORDER_WRAPPEE_HANDLE(MPI_Wtime) },
    ...
    { "MPI_Type_contiguous", RECORDER_MPI_DECL(MPI_Type_contiguous), &RECORDER_WRAPPEE_HANDLE(MPI_Type_contiguous) },
    { "MPI_Type_extent", RECORDER_MPI_DECL(MPI_Type_extent), &RECORDER_WRAPPEE_HANDLE(MPI_Type_extent) },
    { "MPI_Type_free", RECORDER_MPI_DECL(MPI_Type_free), &RECORDER_WRAPPEE_HANDLE(MPI_Type_free) },
    { "MPI_Type_hindexed", RECORDER_MPI_DECL(MPI_Type_hindexed), &RECORDER_WRAPPEE_HANDLE(MPI_Type_hindexed) },
    { "MPI_Op_create", RECORDER_MPI_DECL(MPI_Op_create), &RECORDER_WRAPPEE_HANDLE(MPI_Op_create) },
    { "MPI_Op_free", RECORDER_MPI_DECL(MPI_Op_free), &RECORDER_WRAPPEE_HANDLE(MPI_Op_free) },
    { "MPI_Type_get_envelope", RECORDER_MPI_DECL(MPI_Type_get_envelope), &RECORDER_WRAPPEE_HANDLE(MPI_Type_get_envelope) },
    { "MPI_Type_size", RECORDER_MPI_DECL(MPI_Type_size), &RECORDER_WRAPPEE_HANDLE(MPI_Type_size) },
    ...
    { "MPI_Info_create", RECORDER_MPI_DECL(MPI_Info_create), &RECORDER_WRAPPEE_HANDLE(MPI_Info_create) },
    { "MPI_Info_set", RECORDER_MPI_DECL(MPI_Info_set), &RECORDER_WRAPPEE_HANDLE(MPI_Info_set) },
    { "MPI_Info_get", RECORDER_MPI_DECL(MPI_Info_get), &RECORDER_WRAPPEE_HANDLE(MPI_Info_get) },
